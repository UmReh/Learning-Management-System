...
?>
<div class="main-head wfull">Migration</div>

<form action="migration.php" method="POST" class="stuReg wfull">
    <table>
        <tr>
            <th>Select Class : </th>
            <td>
        ...
        <tr>
            <th> <input type="submit" name="submit" value="Submit"  class="readmore-btn"></th>
        </tr>
    </table>
...
<table class="display">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="migration/<?php echo $result2['migration'];?>"class="readmore" target="blank">Click Here</a></td>
        </tr>
    </tbody>
</table>
<?php }
